...
function App() {
  ...
  return (
    <div className="text-white min-h-screen gradient-bg">
      ...
      <header className="relative h-[40dvh]">
      ...
      <main>
        ...
        <section id="sobre" className="py-20 px-5 md:px-20">
        ...
        <section id="planos" className="py-20 px-5 md:px-10">
        ...
        { }
        <section id="feedbacks" className="py-20 px-5 md:px-20">
        ...
        <section id="contato" className="py-16 px-5 md:px-16 text-center">
